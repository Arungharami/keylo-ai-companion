...
const SignupPage = () => {
  ...
  const getStrength = () => {
    ...
    if (password.length < 10) return { label: "Good", color: "bg-primary", width: "66%" };
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="glass rounded-xl p-6 shadow-card">
          <Button variant="hero-outline" className="w-full mb-4" onClick={() => toast.info("Google auth will be connected with Lovable Cloud")}>
