...
const PricingSection = () => {
  ...
  return (
    <section id="pricing" className="py-24 gradient-hero-bg">
      <div className="container">
        ...
        >
          ...
          <div className="inline-flex items-center gap-3 glass rounded-full px-1 py-1">
            <button
              ...
              className={`text-sm px-4 py-1.5 rounded-full transition-all ${!yearly ? "gradient-bg text-primary-foreground" : "text-muted-foreground"}`}
            >
              Monthly
            </button>
            <button
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          >
            ...
            <Link to="/signup">
              <Button variant="hero-outline" className="w-full">Get Started</Button>
            </Link>
          </motion.div>
          ...
          >
            <div className="absolute top-0 right-0 gradient-bg text-primary-foreground text-xs font-medium px-3 py-1 rounded-bl-lg">Popular</div>
            <h3 className="font-semibold text-foreground mb-1">Premium</h3>
            <p className="text-sm text-muted-foreground mb-4">Unlimited conversations with Keylo</p>
            ...
            <p className="text-xs text-muted-foreground text-center mt-3">Cancel anytime. No commitment.</p>
          </motion.div>
        </div>
      </div>
    </section>
